# What is Git & GitHub? - Preparation Guide

This is a preparation guide for the **What is Git & GitHub** introductory lecture.

Got a GitHub account?  
If not, [GitHub Account](#github-account) section guides you through creating one.

Got Git installed on your device?
If not, follow along the [macOS](#macos---gitのインストール) or [Windows](#windows-10---gitのインストール) section to install Git locally.

---

## Overview <!-- omit in toc -->
  - [GitHub Account](#github-account)
    <!-- - [Step 1 - GitHub Accountを作成する](#step-1---github Accountを作成する)
...
### Step 2 - Enable 2-Step Security Option
  1. Access GitHub's security settings: [github.com/settings/security](https://github.com/settings/security)
     - `Two-factor authentication` > Click on `Enable two-factor authentication` button
     - Select `Set up using an app` option.

  2. Use an Authenticator App
     - Examples: [Microsoft](https://www.microsoft.com/en-us/account/authenticator), [Authy](https://authy.com/guides/github/), [Enpass](https://www.enpass.io/)

#### Resources <!-- omit in toc -->
  - GitHub Help Doc: [Setup Two-Factor Authentication](https://help.github.com/github/authenticating-to-github/configuring-two-factor-authentication)
...
### Step 3 - コマンドラインの個人アクセストークン  
  ...
  2. このtokenはターミナル経由でGitHub Accountにアクセスする時に使用します  
